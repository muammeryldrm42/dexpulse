...
function renderCards(items){
  ...
  for (const it of filtered){
    ...
    card.innerHTML = `
      ...
      <div class="metrics">
        <div class="kv"><div class="k">Price</div><div class="v">${priceText}</div></div>
...
async function openDetail(address){
  try{
    ...
    const priceValue = Number(p.priceUsd);
    const priceDetail = Number.isFinite(priceValue) ? fmtUSD(priceValue) : "—";
    ...
    $("#detail").innerHTML = `
      ...
      <div class="metrics">
        <div class="kv"><div class="k">Price</div><div class="v">${priceDetail}</div></div>
